...
<button type="button" class="btn btn-success btn-sm"
        onclick="window.location='/addManager/${"add"}/${"null"}'">Add Manager
</button>
<br><br>
...
<%--        <th>View</th>--%>
    ...
    <c:forEach var="managerObj" items="${managersList}">
        <tr>
            <td>${managerObj.name}</td>
            <td>${managerObj.address}</td>
            <td>${managerObj.mobile}</td>
            <td>${managerObj.email}</td>
            <td>${managerObj.status}</td>
            <td>
                <button type="button" id="btn1" class="btn btn-success btn-sm"
                   onclick="window.location='/addManager/${"edit"}/${managerObj.id}'">Edit
                </button>
            </td>
          <%--  <td>
                <button type="button" id="btn2" class="btn btn-success btn-sm"
                        onclick="window.location='/viewSalesPartnerData/${managerObj.id}'">View
                </button>
            </td>--%>
